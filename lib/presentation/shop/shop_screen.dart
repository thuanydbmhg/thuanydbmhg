...
import 'package:flutter_architecture/presentation/shop/widget/list_product_category.dart';
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          ...
                          return GestureDetector(
                            onTap: ()
                            {
                              controller.selectListProductByCategory(itemCategory.id!);
                              Get.to(()=>ListProductCategory(title: itemCategory.name!));
                            },
                            child: Container(
                              padding: EdgeInsets.symmetric(horizontal: 16.w),
                              margin: EdgeInsets.symmetric(horizontal: 8.w),
