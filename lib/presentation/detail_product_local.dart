...
class DetailProductLocal extends StatefulWidget {
  final ItemGroceryLocal productData;
  DetailProductLocal({Key? key,required this.productData}) : super(key: key);

  @override
  State<DetailProductLocal> createState() => _DetailProductLocalState();
}

class _DetailProductLocalState extends State<DetailProductLocal> {
  int _currentPage = 0;
